...
export const countries = [
  ...
  { name: "สหราชอาณาจักร", nameEn: "United Kingdom", code: "GB", flag: "🇬🇧" },
  { name: "ฝรั่งเศส", nameEn: "France", code: "FR", flag: "🇫🇷" },
  { name: "เยอรมนี", nameEn: "Germany", code: "DE", flag: "🇩🇪" },
  { name: "อิตาลี", nameEn: "Italy", code: "IT", flag: "🇮🇹" },
  { name: "สเปน", nameEn: "Spain", code: "ES", flag: "🇪🇸" },
  { name: "เนเธอร์แลนด์", nameEn: "Netherlands", code: "NL", flag: "🇳🇱" },
  { name: "สวิตเซอร์แลนด์", nameEn: "Switzerland", code: "CH", flag: "🇨🇭" },
...
const airports: Record<string, { code: string; name: string }> = {
  ...
  GB: { code: "LHR", name: "สนามบินฮีทโธรว์" },
  FR: { code: "CDG", name: "สนามบินชาร์ล เดอ โกล" },
  DE: { code: "FRA", name: "สนามบินแฟรงก์เฟิร์ต" },
  IT: { code: "FCO", name: "สนามบินฟิอูมิชิโน" },
  ES: { code: "MAD", name: "สนามบินบาราคัส" },
  NL: { code: "AMS", name: "สนามบินสคิปโพล" },
  CH: { code: "ZRH", name: "สนามบินซูริก" },
